...
$sql = "SELECT d.id, d.num_sequence, d.date_saisir, d.objet_saisir, dest.nom AS destinataire, d.nom_fichier, d.lu
        FROM documents d
        JOIN destinataires dest ON d.destinataire_id = dest.id
        WHERE d.envoyeur = ?
...
<div class="container">
    ...
    <thead>
    <tr>
    <th>#</th><th>Numéro</th><th>Date</th><th>Objet</th><th>Destinataire</th><th>Fichier</th><th>Statut</th>
    </tr>
    </thead>
    <tbody>
    ...
    <td data-label="Destinataire"><?= htmlspecialchars($doc['destinataire']); ?></td>
    <td data-label="Fichier"><a class="download-link" href="download.php?file=<?= urlencode($doc['nom_fichier']); ?>">Télécharger</a></td>
    <td data-label="Statut">
    <?php if($doc['lu']): ?>
        <span class="status validated">Validé</span>
    <?php else: ?>
        <span class="status not-read">Non lu</span>
    <?php endif; ?>
    </td>
    </tr>
    <?php endwhile; ?>
